...
export function Quote({
  ...
  return (
    <Alert
      className={cn(
        "border-0 bg-border border-s-4 border-s-muted-foreground pl-3 py-2 min-w-64",
        className,
      )}
    >
      <AlertTitle className="w-fit">
        <em>
          <blockquote className="before:content-['“'] before:text-2xl after:text-2xl before:mr-1 after:ml-1 after:content-['„']">
            {data.quote}
          </blockquote>
        </em>
      </AlertTitle>
